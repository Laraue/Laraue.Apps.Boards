...
namespace Laraue.Apps.StructuredMessages.DataAccess.Migrations
{
    ...
    [Migration("20260815093236_CreateLinkedTelegramChatAndAddLinkChatPermission")]
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.LinkedTelegramChat", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_linked_telegram_chat");

                    b.HasIndex("ExternalChatId")
                        .IsUnique()
                        .HasDatabaseName("ix_linked_telegram_chat_external_chat_id");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_linked_telegram_chat_owner_id");

                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_linked_telegram_chat_status_id");

                    b.ToTable("linked_telegram_chat", (string)null);
                });
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.LinkedTelegramChat", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.User", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_linked_telegram_chat_users_owner_id");
                    ...
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.Status", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_linked_telegram_chat_statuses_status_id");
