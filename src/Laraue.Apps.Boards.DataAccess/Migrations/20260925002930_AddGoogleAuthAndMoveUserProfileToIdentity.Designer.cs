...
namespace Laraue.Apps.Boards.DataAccess.Migrations
{
    ...
    [Migration("20260925002930_AddGoogleAuthAndMoveUserProfileToIdentity")]
    partial class AddGoogleAuthAndMoveUserProfileToIdentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrganizationId", "CreatedByUserId")
                        .HasDatabaseName("ix_api_keys_organization_id_created_by_user_id");
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.OrganizationLog", b =>
                {
                    ...
                    b.HasIndex("ApiKeyId")
                        .HasDatabaseName("ix_organization_logs_api_key_id");
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.RetroCard", b =>
                {
                    ...
                    b.HasIndex("AssigneeId")
                        .HasDatabaseName("ix_retro_cards_assignee_id");

                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_retro_cards_author_id");

                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_retro_cards_group_id");
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.RetroCardGroup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_retro_card_groups");

                    b.HasIndex("RetroId")
                        .HasDatabaseName("ix_retro_card_groups_retro_id");

                    b.ToTable("retro_card_groups", (string)null);
                });
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.ApiKey", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.OrganizationLog", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.ApiKey", "ApiKey")
                        .WithMany()
                        .HasForeignKey("ApiKeyId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_organization_logs_api_keys_api_key_id");
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.RetroCard", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.User", "Assignee")
                        ...
                        .HasForeignKey("AssigneeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_retro_cards_users_assignee_id");
                    ...
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.RetroCardGroup", "Group")
                        .WithMany("Cards")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_retro_cards_retro_card_groups_group_id");
            ...
            modelBuilder.Entity("Laraue.Apps.Boards.DataAccess.Models.RetroCardGroup", b =>
                {
                    b.HasOne("Laraue.Apps.Boards.DataAccess.Models.Retro", "Retro")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_retro_card_groups_retros_retro_id");
